...
if __name__ == "__main__":
    print("Should return False for pins which are not 4 or 6 digits long".center(30, '='))
    ...
    print("\nShould return False for pins which contain characters other than digits".center(30, '='))
